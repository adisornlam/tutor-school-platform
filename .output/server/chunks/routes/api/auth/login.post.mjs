globalThis.__timing__.logStart('Load chunks/routes/api/auth/login.post');import { d as defineEventHandler, r as readBody, c as createError, t as login, u as setCookie } from '../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'stream';
...
export { login_post as default };;globalThis.__timing__.logEnd('Load chunks/routes/api/auth/login.post');
