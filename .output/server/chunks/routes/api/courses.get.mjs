globalThis.__timing__.logStart('Load chunks/routes/api/courses.get');import { d as defineEventHandler, a as getQuery, q as query, c as createError } from '../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'stream';
...
export { courses_get as default };;globalThis.__timing__.logEnd('Load chunks/routes/api/courses.get');
