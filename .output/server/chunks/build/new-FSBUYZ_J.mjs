globalThis.__timing__.logStart('Load chunks/build/new-FSBUYZ_J');import { _ as __nuxt_component_0 } from './nuxt-link-CODr8WH9.mjs';
import { defineComponent, ref, withCtx, createBlock, openBlock, createVNode, unref, createTextVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1 class="text-3xl font-bold">เพิ่มหน้าเว็บไซต์ใหม่</h1></div></div>`);
      if (unref(error)) {
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/new-FSBUYZ_J');
//# sourceMappingURL=new-FSBUYZ_J.mjs.map
