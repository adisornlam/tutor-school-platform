globalThis.__timing__.logStart('Load chunks/build/index-DZHCqHn-');import { _ as __nuxt_component_0 } from './UserModal-C1fGoxGH.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex items-center justify-between mb-6"><h1 class="text-3xl font-bold">จัดการผู้ใช้งาน</h1><button class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center space-x-2"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg><span>เพิ่มผู้ใช้งาน</span></button></div><div class="bg-white rounded-lg shadow p-4 mb-6"><div class="grid grid-cols-1 md:grid-cols-3 gap-4"><div><label class="block text-sm font-medium text-gray-700 mb-2">ค้นหา</label><input${ssrRenderAttr("value", unref(filters).search)} type="text" placeholder="ค้นหาด้วย username, email, ชื่อ" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"></div><div><label class="block text-sm font-medium text-gray-700 mb-2">บทบาท</label><select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(filters).role) ? ssrLooseContain(unref(filters).role, "") : ssrLooseEqual(unref(filters).role, "")) ? " selected" : ""}>ทั้งหมด</option><option value="system_admin"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).role) ? ssrLooseContain(unref(filters).role, "system_admin") : ssrLooseEqual(unref(filters).role, "system_admin")) ? " selected" : ""}>System Admin</option><option value="owner"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).role) ? ssrLooseContain(unref(filters).role, "owner") : ssrLooseEqual(unref(filters).role, "owner")) ? " selected" : ""}>Owner</option><option value="admin"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).role) ? ssrLooseContain(unref(filters).role, "admin") : ssrLooseEqual(unref(filters).role, "admin")) ? " selected" : ""}>Admin กลาง</option><option value="branch_admin"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).role) ? ssrLooseContain(unref(filters).role, "branch_admin") : ssrLooseEqual(unref(filters).role, "branch_admin")) ? " selected" : ""}>Branch Admin</option><option value="tutor"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).role) ? ssrLooseContain(unref(filters).role, "tutor") : ssrLooseEqual(unref(filters).role, "tutor")) ? " selected" : ""}>Tutor</option><option value="parent"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).role) ? ssrLooseContain(unref(filters).role, "parent") : ssrLooseEqual(unref(filters).role, "parent")) ? " selected" : ""}>Parent</option><option value="student"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).role) ? ssrLooseContain(unref(filters).role, "student") : ssrLooseEqual(unref(filters).role, "student")) ? " selected" : ""}>Student</option></select></div><div><label class="block text-sm font-medium text-gray-700 mb-2">สถานะ</label><select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(filters).status) ? ssrLooseContain(unref(filters).status, "") : ssrLooseEqual(unref(filters).status, "")) ? " selected" : ""}>ทั้งหมด</option><option value="active"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).status) ? ssrLooseContain(unref(filters).status, "active") : ssrLooseEqual(unref(filters).status, "active")) ? " selected" : ""}>Active</option><option value="inactive"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).status) ? ssrLooseContain(unref(filters).status, "inactive") : ssrLooseEqual(unref(filters).status, "inactive")) ? " selected" : ""}>Inactive</option><option value="suspended"${ssrIncludeBooleanAttr(Array.isArray(unref(filters).status) ? ssrLooseContain(unref(filters).status, "suspended") : ssrLooseEqual(unref(filters).status, "suspended")) ? " selected" : ""}>Suspended</option></select></div></div></div><div class="bg-white rounded-lg shadow overflow-hidden">`);
      if (unref(loading)) {
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/index-DZHCqHn-');
//# sourceMappingURL=index-DZHCqHn-.mjs.map
