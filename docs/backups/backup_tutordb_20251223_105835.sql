...
--
-- Table structure for table `calendar_appointment_participants`
--

DROP TABLE IF EXISTS `calendar_appointment_participants`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `calendar_appointment_participants` (
  ...
  `user_id` int(11) NOT NULL,
  `participant_type` enum('student','parent','tutor','admin','other') COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('pending','accepted','declined','maybe') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_status` (`status`),
  CONSTRAINT `calendar_appointment_participants_ibfk_1` FOREIGN KEY (`appointment_id`) REFERENCES `calendar_appointments` (`id`) ON DELETE CASCADE,
  CONSTRAINT `calendar_appointment_participants_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `calendar_appointment_participants`
--

LOCK TABLES `calendar_appointment_participants` WRITE;
/*!40000 ALTER TABLE `calendar_appointment_participants` DISABLE KEYS */;
/*!40000 ALTER TABLE `calendar_appointment_participants` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `calendar_appointments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `calendar_appointments` (
  ...
  `appointment_type` enum('student','meeting','parent','staff','other') COLLATE utf8mb4_unicode_ci DEFAULT 'student',
  ...
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_user_datetime` (`user_id`,`start_datetime`),
  KEY `idx_status` (`status`),
  KEY `idx_type` (`appointment_type`),
  KEY `idx_datetime` (`start_datetime`),
  CONSTRAINT `calendar_appointments_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `calendar_appointments`
--

LOCK TABLES `calendar_appointments` WRITE;
/*!40000 ALTER TABLE `calendar_appointments` DISABLE KEYS */;
/*!40000 ALTER TABLE `calendar_appointments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `calendar_event_shared_with`
--

DROP TABLE IF EXISTS `calendar_event_shared_with`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `calendar_event_shared_with` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `calendar_event_shared_with_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `calendar_events` (`id`) ON DELETE CASCADE,
  CONSTRAINT `calendar_event_shared_with_ibfk_2` FOREIGN KEY (`shared_with_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `calendar_event_shared_with`
--

LOCK TABLES `calendar_event_shared_with` WRITE;
/*!40000 ALTER TABLE `calendar_event_shared_with` DISABLE KEYS */;
/*!40000 ALTER TABLE `calendar_event_shared_with` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `calendar_events` (
  ...
  `shared_scope` enum('private','tutors','students','parents','admins','branch_admins','branch_students','branch_parents','public') COLLATE utf8mb4_unicode_ci DEFAULT 'private',
  `shared_branch_id` int(11) DEFAULT NULL,
  `event_type` enum('personal','meeting','holiday','announcement','other') COLLATE utf8mb4_unicode_ci DEFAULT 'personal',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `shared_branch_id` (`shared_branch_id`),
  KEY `idx_user_datetime` (`user_id`,`start_datetime`),
  KEY `idx_shared_scope` (`is_shared`,`shared_scope`,`shared_branch_id`),
  KEY `idx_datetime` (`start_datetime`),
  KEY `idx_event_type` (`event_type`),
  CONSTRAINT `calendar_events_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `calendar_events_ibfk_2` FOREIGN KEY (`shared_branch_id`) REFERENCES `branches` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `calendar_task_shared_with`
--

DROP TABLE IF EXISTS `calendar_task_shared_with`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `calendar_task_shared_with` (
  ...
  KEY `idx_user` (`shared_with_user_id`),
  CONSTRAINT `calendar_task_shared_with_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `calendar_tasks` (`id`) ON DELETE CASCADE,
  CONSTRAINT `calendar_task_shared_with_ibfk_2` FOREIGN KEY (`shared_with_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `calendar_task_shared_with`
--

LOCK TABLES `calendar_task_shared_with` WRITE;
/*!40000 ALTER TABLE `calendar_task_shared_with` DISABLE KEYS */;
/*!40000 ALTER TABLE `calendar_task_shared_with` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `calendar_tasks` (
  ...
  `color` varchar(7) COLLATE utf8mb4_unicode_ci DEFAULT '#10B981',
  `is_shared` tinyint(1) DEFAULT '0',
  `shared_scope` enum('private','tutors','students','parents','admins','branch_admins','public') COLLATE utf8mb4_unicode_ci DEFAULT 'private',
  `shared_branch_id` int(11) DEFAULT NULL,
  `category` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `calendar_tasks_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `calendar_tasks_ibfk_2` FOREIGN KEY (`shared_branch_id`) REFERENCES `branches` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `calendar_tasks` WRITE;
/*!40000 ALTER TABLE `calendar_tasks` DISABLE KEYS */;
/*!40000 ALTER TABLE `calendar_tasks` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `chat_room_participants` VALUES (1,1,9,'student','2025-12-22 00:54:34','2025-12-23 01:07:33'),(2,1,3,'tutor','2025-12-22 00:54:34','2025-12-23 08:08:26');
...
INSERT INTO `chat_rooms` VALUES (1,1,9,3,'active','2025-12-23 08:08:26','2025-12-22 00:54:34','2025-12-23 08:08:26');
...
-- Dump completed on 2025-12-23 10:58:36
